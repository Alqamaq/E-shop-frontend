...
const ShopCreate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (state === "Sign Up") {
            ...
            axios.post(`${server}/shop/login-shop`, { email, password }, { withCredentials: true })
                .then((res) => {
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
                    {state === 'Login' ? 'Login to Seller account' : 'Register as a seller'}
                </h2>
            </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        }
                        {
                            ...
                            <div className='w-full'>
                                ...
                                <input className='appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm'
                                    type="number" onChange={(e) => setPhoneNumber(e.target.value)} value={phoneNumber} />
                            </div>
                        }
                        {
                            state === 'Sign Up'
                        ...
                        }
                        {
                            ...
                            <div className='w-full'>
                                ...
                                <input className='appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm'
                                    type="number" onChange={(e) => setZipCode(e.target.value)} value={zipCode} />
                            </div>
                        }
                        <div>
                            <label
