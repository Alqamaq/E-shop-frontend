...
const ProductDetail = ({ data }) => {
    ...
    const handleMessageSubmit = () => {
        navigate('/conversation?create-new-conversation')
                        ...
                        <div className="block w-full 800px:flex">
                            <div className="w-full 800px:w-[50%]">
                                ...
                                <div className="w-full flex">
                                    ...
                                    <div className={`${select === 1 ? 'border' : 'null'} cursor-pointer`} >
                                        <img src={`${backend_URL}${data?.images[1].public_id}`} alt=""
                                            className="h-[200px]"
                                            onClick={() => setSelect(1)} />
                            ...
                            <div className="w-full 800px:w-[50%] pt-5">
                                ...
                                <div className="flex pt-3">
                                    <h4 className={`${styles.productTitle}`}>${data.discountPrice}</h4>
                                ...
                                <div className={`${styles.button} flex rounded h-11 items-center mt-6`}>
                                    <span className="text-white flex items-center"  onClick={() => addToCartHandler(data._id)}>Add To Cart <AiOutlineShoppingCart size={20} className="ml-1" /></span>

                                </div>

                                <div className="flex items-center pt-8">
                                    <Link to={`/shop/${data?.shop._id}`}>
                                        <img src={`${backend_URL}${data.shop.avatar.url}`} alt=""
