    ...
    const addToCartHandler = (id)=>{
        ...
        if(isItemExist){
            ...
            if(data.stock<count){
                ...
                toast.success('Item added stuccessfuly')
            }
        }
                ...
                {data ? (
                    ...
                    <div className='fixed w-full h-screen top-0 left-0 bg-[#00000030] z-40 flex items-center justify-center'>
                        <div className='w-[90%] 800px:w-[60%] h-[90vh] overflow-y-scroll 800px:h-[75vh] bg-white rounded-md shadow-sm relative p-4'>
                            <RxCross1 size={30} className='absolute right-3 top-3 cursor-pointer' onClick={() => setOpen(false)} />
                            <div className='w-full block 800px:flex mt-5'>
                                <div className='w-full 800px:w-[50%]'>
                                    <img src={`${backend_URL}${imageUrl}`} alt={data.name} />
                                    <div className='flex'>
